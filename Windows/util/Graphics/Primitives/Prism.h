...
{
  public:
    template <class V> static IndexedTriangleList<V> MakeTesselated(int longDiv)
    {
    ...
    template <class V> static IndexedTriangleList<V> MakeTesselatedIndependentCapNormals(int longDiv)
    {
        namespace dx = DirectX;
        assert(longDiv >= 3);
