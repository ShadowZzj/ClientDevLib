...
{
  public:
    template <class V> static IndexedTriangleList<V> Make()
    {
    ...
    template <class V> static IndexedTriangleList<V> MakeSkinned()
    {
        namespace dx = DirectX;
        ...
        return {std::move(vertices), {0, 2, 1, 2, 3, 1, 4, 8,  5,  5, 8,  9, 2,  6, 3, 3,  6, 7,
                                      4, 5, 7, 4, 7, 6, 2, 10, 11, 2, 11, 6, 12, 3, 7, 12, 7, 13}};
    }
    template <class V> static IndexedTriangleList<V> MakeIndependent()
    {
        constexpr float side = 1.0f / 2.0f;
    ...
    template <class V> static IndexedTriangleList<V> MakeIndependentTextured()
    {
