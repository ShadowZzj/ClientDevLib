...
BOOL zzj::ServiceInternal::OnInit() { return (service->*oninitFunc)(); }
void zzj::ServiceInternal::Run() { return (service->*runningFunc)(); }
void zzj::ServiceInternal::OnStop() { return (service->*onstopFunc)(); }
void zzj::ServiceInternal::OnShutdown() { return (service->*onshutdownFunc)(); }
void zzj::ServiceInternal::OnPreShutDown() { return (service->*onPreShutdownFunc)(); }
void zzj::ServiceInternal::OnSessionChange(zzj::Session::SessionMessage message,
                                           zzj::Session session)
{
...
int zzj::Service::Install(ServiceInterface *otherService)
{
    ...
    result = WinService::InstallService(serviceName.c_str(), displayName.c_str(),
                                        description.c_str(), binPath.c_str());
    return result;
}
...
{
    return WinService::GetServiceBinPath(serviceName.c_str());
}
int zzj::Service::SetServiceBinPath(const std::string &binPath)
{
    return WinService::SetServiceBinPath(serviceName.c_str(), binPath.c_str());
}
